  ...
  var a = (function b(c, d, e) {
  ...
  })(
    {
        ...
        function (a, b, c) {
          ...
          (f.prototype.init = function () {
            ...
            (f.prototype.event = function (a) {
              return d.isObject(a)
                ? (d.assert(a.event, "a.event no event"),
                  d.assert(a.listener, "a.event no listener"),
                  [a.event, a.listener].join("."))
                : a;
            }),
            (f.prototype.add = function (a, b, c, d) {
              (c = c === !0 ? !0 : !1), (a = this.event(a));
              var e = { func: b, one: c, ctx: d };
              return (
            ...
            (f.prototype.off = function (a, b) {
              ...
              return (
                0 === c.length ? delete this.data[a] : (this.data[a] = c), this
              );
            }),
            ...
            (f.prototype.get = function (a, b, c, e) {
              d.isFunction(b) && ((c = b), (b = {}), c && (e = c)),
                b || (b = {}),
                d.assert(c),
                b.hasOwnProperty("listener") ||
                  (b.listener = "l" + d.getUUID()),
                this.one({ event: a, listener: b.listener }, c, e),
                this.notify(a, b);
            }),
            (f.prototype.notify = function () {
              ...
              var c,
                ...
                g = [];
              return (
                d.each(this.data[b], function (a) {
                  g.push(a), a.one === !1 && f.push(a);
                }),
                0 === f.length ? delete this.data[b] : (this.data[b] = f),
                d.each(
                  g,
                  function (f) {
                    try {
      ...
      2: [
        function (a, b, c) {
          ...
          (g.random = function (a) {
            ...
            (g.API.prototype.init = function (a) {
              d.isString(a)
                ? (this.key = a)
                : d.isNone(a) || (this.key = a.key),
                (this.key = this.key ? this.key : f.EMB_API_KEY),
                (this.protocol =
            ...
            (g.API.prototype._buildUrl = function (a, b) {
              ...
              return (
                (b = b ? b : {}),
                b.key || (b.key = this.key),
                c + "?" + g.safeCreateQuery(b)
              );
            }),
            (g.API.prototype._data = function (a, b, c, f) {
              if (
                (e.console.log(a, b, c, f),
                d.isNone(f) && d.isFunction(c) && ((f = c), (c = {})),
                d.isNone(f))
              )
                return !1;
              if (d.isString(b)) {
            ...
            (g.Display = function () {}),
            (g.Display.prototype._buildUrl = function (a, b, c) {
              var e = { key: f.EMB_API_KEY, url: b },
                h = d.extend(e, d.isNone(c) ? {} : c),
                i =
                  "://i-cdn.embed.ly/1/display" +
                  ("display" === a ? "" : "/" + a);
              return (
                (f.EMB_HTTPS ? "https" : "http") +
                i +
                "?" +
                g.safeCreateQuery(h)
              );
        ...
        { "./browser.js": 4, "./utils.js": 29, conf: "conf" },
      ],
      3: [
        function (a, b, c) {
          var d = a("./utils"),
            e = a("./urlparse.js"),
            f = { disallowed: ["1kd60cb"] };
      ...
      4: [
          ...
          (h.supports = {
            ...
            (h.detect = function () {
              var a = function (a, b) {
                b
                  ...
                  : e.addClass(document.body, "no-" + a);
              };
              a("touch", h.supports.touch()),
                a("boxshadow", h.supports.boxShadow()),
                a("borderradius", h.supports.borderRadius()),
                a("rgba", h.supports.rgba()),
                a("mediaquery", h.supports.mediaQuery());
            }),
            (h.console = {
              _log: function (a, b) {
                if (
                  (g.EMB_DEBUG || window.EMB_DEBUG) &&
                  !d.isNone(window.console) &&
                  window.console &&
                  window.console[a]
                )
                  if (window.console[a].apply)
                    window.console[a].apply(window.console, b);
                  else {
            ...
            (h.open = function (a, b, c, e, f, g) {
              ...
              var j = window.open(
                a,
                b,
                "scrollbars=no, resizable=1, width=" +
                  c +
                  ", height=" +
                  e +
                  ", top=" +
            ...
            (h.window = {
              innerHeight: function () {
                return d.isNone(window.innerHeight)
                  ? document.documentElement.clientHeight
                  : window.innerHeight;
              },
              innerWidth: function () {
                return d.isNone(window.innerWidth)
                  ? document.documentElement.clientWidth
                  : window.innerWidth;
              },
              scrollY: function () {
                return d.isNone(window.pageYOffset)
                  ? (
            ...
            (h.location = {
              ...
              params: function () {
                return d.extend(
                  {},
                  f.parseQuery(document.location.search),
                  f.parseQuery(h.location.hash())
                );
              },
            }),
            (h.mobile = function () {
            ...
            (h.animateScroll = function (a, b) {
              ...
              var m = function () {
                clearInterval(c),
                  h.console.log("duration", new Date().getTime() - i),
                  e.detachEvent("scroll", d);
              };
              (c = setInterval(function () {
                return (
                  (f += k),
                  l(f) ? (m(), !1) : (window.scrollTo(0, f), void (j = !0))
                );
              }, 10)),
                (d = function () {
        ...
        { "./dom.js": 7, "./urlparse.js": 28, "./utils.js": 29, conf: "conf" },
      ],
      5: [
        function (a, b, c) {
          var d = !1,
      ...
      6: [
        function (a, b, c) {
          var d = a("./iframes/comms.js").one,
            e = a("./utils.js"),
            f = { started: !1, instance: null };
          (f.EVENTS = [
            "xcomm.options.access",
            "xcomm.media.recommend",
            "xcomm.card.recommend",
            "xcomm.log.event",
            "xcomm.page.progress",
          ]),
            (f.clear = function () {
              f.instance && (f.instance.remove(), (f.instance = null)),
                (f.started = !1);
            }),
            (f.connect = function (a, b) {
              ...
              return (
                (f.instance = c),
                e.each(f.EVENTS, function (b) {
                  c.on(b, function (c) {
                    var d = b;
                    c.listener && (d = { event: b, listener: c.listener }),
                      a.notify(d, c);
                  }),
                    a.on(b, function (a) {
                      c.send(b, a);
        ...
        { "./iframes/comms.js": 13, "./utils.js": 29 },
      ],
      7: [
        function (a, b, c) {
          var d = a("./utils.js"),
          ...
          (f.toArray = function (a) {
            ...
            (f.all = function (a) {
              ...
              return document.querySelectorAll
                ? f.toArray(document.querySelectorAll(a))
                : b;
            }),
            (f.one = function (a, b) {
              var c = f.all(a, b);
            ...
            (f.replace = function (a, b) {
              d.assert(
                d.isElement(a),
                "replace requires an element to be replaced"
              ),
                d.assert(
                  d.isElement(b),
                  "replace requires an element to replace with."
                ),
                a.parentNode.replaceChild(b, a);
            }),
            (f.remove = function (a) {
              return d.isElement(a) && d.isElement(a.parentNode)
                ? void a.parentNode.removeChild(a)
                : !1;
            }),
            (f.hide = function (a) {
              return (
                d.isString(a) && (a = f.one(a)),
                d.isElement(a) && (a.style.display = "none"),
                a
              );
            }),
            (f.show = function (a, b) {
              return (
                d.isString(a) && (a = f.one(a)),
                d.isElement(a) &&
                  (a.style.display = b ? "inline-block" : "block"),
                a
              );
            }),
            ...
            (f.text = function (a, b) {
              if ((d.isString(a) && (a = f.one(a)), !a || !d.isElement(a)))
                return null;
            ...
            (f.data = function (a, b, c) {
              d.assert(a && d.isElement(a), "dom.data needs an element."),
                d.assert(b && d.isString(b), "dom.data needs an attr.");
              var e = d.camelCase(b, 1);
              return d.isNone(c)
                ? d.isNone(a.dataset)
                  ? a.getAttribute("data-" + b)
                  : d.isNone(a.dataset[e])
                  ? null
                  : a.dataset[e]
                : void (d.isNone(a.dataset)
                    ? a.setAttribute("data-" + b, c)
                    : (a.dataset[e] = c));
            }),
            (f.attrize = function (a) {
              return a && d.isObject(a)
                ? d
                    .map(a, function (a, b) {
                      return b + '="' + a + '"';
                    })
            ...
            (f.event = function (a) {
              ...
              return (
                ...
                !a.metaKey && a.ctrlKey && (b.metaKey = b.ctrlKey),
                (b.stop = function () {
            ...
            e.EMB_DEBUG === !0 && (window.dom = f),
            (b.exports = f);
        },
        { "./utils.js": 29, conf: "conf" },
      ],
      8: [
        function (a, b, c) {
          var d = a("./utils.js"),
          ...
          (h.add = {}),
            (h.add.cards = function (a) {
              if (d.isString(a)) {
                if (".embedly-card" === a) return !1;
                h.selectors.cards.push({ selector: a });
                ...
                if (
                  ...
                  (b.selector = a.selector), h.selectors.cards.push(b);
                else {
            ...
            (h.select = function (a, b) {
              return "." === a.substr(0, 1)
                ? f.hasClass(b, a.substr(1))
                  ? !0
                  : !1
                : d.contains(f.all(a), b)
                ? !0
                : !1;
            }),
            (h.each = function (a) {
              ...
              if ("A" === a.nodeName || "BLOCKQUOTE" === a.nodeName)
                for (b = 0; b < h.selectors.cards.length; b++)
                  if (((c = h.selectors.cards[b]), h.select(c.selector, a)))
                    return (a._em_opts = c), { name: "card", node: a };
              if ("A" === a.nodeName)
                for (b = 0; b < h.selectors.button.length; b++)
                  if (h.select(h.selectors.button[b], a))
                    return { name: "button", node: a };
              if ("DIV" === a.nodeName)
                for (b = 0; b < h.selectors.slideshow.length; b++)
                  if (h.select(h.selectors.slideshow[b], a))
                    return { name: "slideshow", node: a };
              if ("IFRAME" === a.nodeName) {
                if ("embedly-embed" === a.className)
                  return { name: "iframe", node: a };
                if (
                  a.src &&
                  /\/\/cdn\.embedly\.com\/widgets\/media\.html/.test(a.src)
                )
                  return { name: "iframe", node: a };
                if (null !== h.analytics && h.analytics.replace) {
                  var d = e.replace(a, h.analytics);
                  if (null !== d) return { name: "iframe", node: d };
                }
              }
              return null;
            }),
            (h.release = function () {
                ...
                (a = d.reduce(
                  ...
                  function (a, b) {
                    return d.contains(a, b)
                      ? a
                      : b.className && "embd-" === b.className.substr(0, 5)
                      ? a
                      : (a.push(b), a);
                  },
                  []
              ...
              var b = d.reduce(
                ...
                { cards: [], buttons: [], slideshows: [], iframes: [] }
              );
            ...
            (h.connect = function (a) {
              (h.hub = a),
                a.on("mutation.insert.a", h.queue),
                a.on("mutation.insert.blockquote", h.queue),
                a.on("mutation.insert.iframe", h.queue),
                g.connect(a),
                h.look();
            }),
            (b.exports = h);
          ...
          (j.connect = function (a, b, c) {
            ...
            (i.on = function (a, b, c) {
              ...
              (i.send = function (a, b, c) {
                if (
                  (d.isNone(b) && (b = {}),
                  d.isString(b) && (b = { msg: b }),
                  (b.method = a),
                  m === !1 && !c)
                )
                  return g.console.log("frame.queue", b), l.push(b), !1;
                if (
                  (i.sid && (b.sid = i.sid),
                  g.console.log("frame.send", b),
                  i.__tunnel)
                )
                  i.__tunnel.send(b);
                else if (
                  i.elem.contentWindow &&
                  i.elem.contentWindow.postMessage
                ) {
              ...
              (i.ready = function () {
                m ||
                  (g.console.log("frame.ready", i.name),
                  (m = !0),
                  d.each(l, function (a) {
                    i.send(a.method, a);
                  }));
              ...
              (i.resize = function (a) {
                a.width && i.elem.setAttribute("width", a.width),
                  a.height && i.elem.setAttribute("height", a.height);
              }),
              (i.remove = function () {
                e.remove(i.elem),
                  i.__hub.clear(),
                  i.__tunnel && i.__tunnel.clear(),
                  i._remove && i._remove();
              }),
              k.on("message", function (a) {
                "resize" === a.method && i.resize && i.resize(a),
                  a.event && a.listener
                    ? k.notify({ event: a.event, listener: a.listener }, a)
                    : a.method && k.notify(a.method, a);
              });
            var o = function (a, b) {
            ...
            (j.rendering = function (a) {
              return "1" === e.data(a, "rendering")
                ? !0
                : (e.data(a, "rendering", "1"), !1);
            }),
            (j.create = function (a, b, c, f, g) {
              ...
              var k = d.extend({}, f);
              c.sandbox === !1 &&
                (k.src = i.EMB_FRAME_SRC + a + ".html#sid=" + h),
                c.url && (k.id = "emb_" + d.hash(c.url)),
                (k["class"] = "embedly-" + a);
      ...
      11: [
        function (a, b, c) {
          ...
          (i.one = function (a, b) {
            ...
            return (
              m.one("button.load", function (a) {
                var b = function (a, b) {
                    return function (c) {
                      (a.__tunnel = new h.Tunnel(a.__hub)),
                        c.create(b, a.__tunnel);
                    };
                  },
                  c = b(m, k);
                a.contentWindow.buttons
                  ? c(a.contentWindow.buttons)
                  : (a.contentWindow.onButtonsReady = c);
              }),
              f.replace(a, m.elem),
              m.__appended(),
              m.on("button.click", function () {
                e.window.innerWidth() <= 768 || e.mobile()
                  ? (window.location =
                      "http://embed.ly/code?url=" + encodeURIComponent(k.url))
                  : b.notify("modal.create", k);
              }),
        ...
        function (a, b, c) {
          var d = a("../api.js"),
            ...
            m = {
              ...
              extractless:
                /https:\/\/(\w+\.pinterest\.com\/.*)|(\w+\.reddit\.com\/r\/.*\/comments\/.*)/,
              sandboxless: [
          ...
          (m.isPercent = function (a) {
            ...
            (m.sandbox = function (a) {
              ...
              for (b = 0; b < m.sandboxless.length; b++)
                if (((c = m.sandboxless[b]), c.re.test(a)))
                  return e.isFunction(c.test) ? !c.test(a) : !1;
              return !0;
            }),
            (m.css = function () {
            ...
            (m.options = function (a) {
              ...
              if (
                ...
                e.each(
                  ...
                  function (c) {
                    var d = f.data(a, "card-" + c);
                    e.isNone(d) ||
                      (b.hasOwnProperty("recommendations")
                        ? b.recommendations.push(d)
                        : (b.recommendations = [d]));
                  }
                ),
                ...
                if (e.isNone(i)) {
                  if ("reddit-card" === a.className) {
                    if (
                      ((h = f.toArray(a.querySelectorAll("a"))), h.length > 0)
                    ) {
                      if (((d = h[0]), !d || !d.href)) return !1;
                      b.url = d.href;
                    }
                  } else if (j) {
                    if (((h = a.getElementsByTagName("a")), 0 === h.length))
                      return !1;
                    (d = h[h.length - 1]), (b.url = d.getAttribute("href"));
                  }
                } else
                  (d = f.child(i, "a")),
                    (b.url = d.getAttribute("href")),
                    (b.title = f.text(d)),
                    e.isNone(j)
                      ? (b.description = "0")
                      : (b.description = f.text(j));
              ...
              var k, l, n;
              if (
                (e.each(document.getElementsByTagName("meta"), function (a) {
                  (n = [a.getAttribute("name"), a.getAttribute("property")]),
                    e.contains(n, "twitter:site")
                      ? (l = a.getAttribute("content"))
                      : e.contains(n, "twitter:creator") &&
                        (k = a.getAttribute("content"));
                }),
                k ? (b.twitter_via = k) : l && (b.twitter_via = l),
                !b.url)
              )
                return null;
              var o = g.parse(b.url);
              return o.valid()
                ? ((b.url = o.url),
                  (b.sandbox = m.sandbox(b.url)),
                  b.referrer || (b.referrer = document.URL),
                  b.width && (b.width = m.cleanWidth(b.width)),
                  /thescore\.com/.test(b.referrer) &&
                    (b.key = "900b122ee8ee43f79b2240c831f24429"),
                  b)
                : null;
            });
          ...
          (n.prototype.init = function (a, b, c, d) {
            if (((this.elem = b), (this.options = c), !c.url))
              return (this.error = !0), (this.frame = null), !1;
            (this.error = !1),
            ...
            this.frame.one("card.load", function (a, b) {
              ...
              (this.extract = e.bind(function (a) {
                return this.extracted
                  ? !1
                  : ((this.extracted = !0), void this._extract(a));
              }, this)),
            ...
            j &&
              j.offsetWidth &&
              (j.offsetWidth > 600
                ? (this.frame.elem.style.width = "600px")
                : (this.frame.elem.style.width = j.offsetWidth + "px"));
            var k = f.create("div", { class: "embedly-card" }),
              l = f.create("div", { class: "embedly-card-hug" });
            k.appendChild(l),
            ...
            (n.prototype.done = function (a) {
              var b = a[0].iframe,
                ...
                e = {};
              if (
                (3 === a.length && (e = a[2].media),
                !this.frame.elem.parentNode)
              )
                return !1;
              if (this.options.sandbox === !1)
                this.frame.ready(),
                  this.frame.send("card.create", {
                ...
                var f = function (a, b, d, f) {
                    return function (a) {
                      (f.__tunnel = new l.Tunnel(f.__hub)),
                        a.create(c.body, {
                          options: b,
                          extract: d,
                          media: e,
                ...
                b.contentWindow.cards
                  ? g(b.contentWindow.cards)
                  : (b.contentWindow.onCardsReady = g);
              }
              (this.frame.options = this.options),
                (this.frame.extract = d),
                this._done(this.frame);
            }),
            (m.fetch = function (a, b, c, f) {
              (c = e.extend({}, c ? c : {})),
                ...
                (c = e.map(b, function (a) {
                  return c.override === !0
                    ? e.extend({}, m.options(a), c)
                    : e.extend({}, c, m.options(a));
                }));
              var g = new i(),
                h = [];
              c = e.reduce(
              ...
              return (
                c.protocol && (o = c.protocol),
                (o = o.split(":")[0]),
                e.contains(["http", "https"], o) || (o = "https"),
                (k.scheme = o),
                d.api().card(j, k, function (a) {
                  e.each(a, function (a) {
                    e.each(h, function (b) {
                      b.options.url === a.original_url
                        ? b.extract(a)
                        : b.options.embed === a.original_url && b.media(a);
                    });
                  });
                }),
                g.wait(function (a) {
            ...
            (m.build = function (a, b, c) {
              ...
              return (
                h.isFirefox() &&
                  ((d.elem.style.visibility = "visible"),
                  (d.elem.style.height = "1px")),
                d.on("card.repeat", function (a) {
                  var b = { url: a.url, via: document.location.toString() };
                  e.each(
                    ["image", "embed", "title", "description", "lang"],
                    function (c) {
                ...
                d.on("card.rendered", function (b) {
                  if (((d.url = b.url), (d.type = b.type), "error" === b.name))
                    return d.__hub.notify("card.error", a), d.remove(), !1;
                  if (a._em_opts) {
                    ...
                    if (
                      ...
                      e.isArray(g.types) &&
                        g.types.length > 0 &&
                        !e.contains(g.types, b.type))
                    )
                      return d.__hub.notify("card.error", a), d.remove(), !1;
                  }
                  (d.rendered = !0),
                    !d.options.twitter_via &&
                      b.defaultTwitterVia &&
                      (d.options.twitter_via = b.defaultTwitterVia);
                  var h = d.elem.parentNode;
                  (d.elem.style.display = "block"),
                    (d.elem.style.margin = "0"),
                    (d.elem.style.padding = "0"),
                    (d.elem.style.visibility = "visible"),
                    (d.elem.style.position = "relative"),
                    b.height
                      ? (d.elem.height = b.height)
                      : (d.elem.height = "300"),
                    b.width
                      ? m.isPercent(b.width)
                        ? ((h.style.width = b.width), (d.elem.width = "100%"))
                        : ((d.elem.width = b.width),
                          (h.style.maxWidth = b.width + "px"))
                      : ((d.elem.width = "600"), (h.style.maxWidth = "600px")),
                    (h.style.padding = "0"),
                    (h.style.position = "relative"),
                    (h.style.minWidth = "200px"),
                    "left" === b.align
                      ? (h.style.margin = "5px 0")
                      : "right" === b.align
                      ? (h.style.margin = "5px 0 5px auto")
                      : (h.style.margin = "5px auto"),
                    (d.elem.style.width = null),
                    (d.elem.style.height = null),
                    (d.elem.style.maxWidth = "100%"),
                    (d.elem.style.minWidth = "200px"),
                    f.remove(a),
                    "error" !== b.type &&
                      (c.notify("card.rendered", d.elem, d),
                      b.controls && k.card(d));
                }),
      ...
      13: [
        function (a, b, c) {
          var d = a("../utils.js"),
            ...
            h = a("conf"),
            i = {
              attrs: { frameborder: "0", allowtransparency: "true" },
              styles: {
                border: "none",
                position: "absolute",
                top: "-9999em",
          ...
          (i.one = function (a, b) {
            var c = d.getUUID();
            d.assert(b.name), (b = d.extend({ sid: c }, b ? b : {}));
            var j = d.extend({}, i.attrs);
            (j.id = "emb_xcomm"),
              (j["class"] = "embedly-xcomm"),
              (j.src =
                h.EMB_SECURE_FRAME_SRC + "xcomm.html#" + f.createQuery(b));
      ...
      14: [
        function (a, b, c) {
          ...
          (h.one = function (a, b) {
            if (
              (d.isNone(a) && (a = { url: document.location.toString() }),
              d.isNone(a.url) && (a.url = document.location.toString()),
              (a.protocol = window.location.protocol),
              "window" === a.target)
            )
              return (
                e.open(
                  "http://cdn.embedly.com/widgets/embed?url=" +
            ...
            return (
              c.on("modal.load", function (b) {
                var d = function (a, b) {
                    return function (c) {
                      (a.__tunnel = new g.Tunnel(a.__hub)),
                        c.create(b, a.__tunnel);
                    };
                  },
                  e = d(c, a);
                b.contentWindow.modals
                  ? e(b.contentWindow.modals)
                  : (b.contentWindow.onModalsReady = e);
              }),
              (c.resize = function () {}),
              c.on("modal.close", function () {
                (document.body.style.overflow = "inherit"),
                  document.body.removeChild(c.elem);
              }),
      ...
      15: [
        function (a, b, c) {
          ...
          (j.options = function (a, b) {
            ...
            (j.urls = function (a, b) {
              return d.isArray(b.urls) && b.urls.length > 0
                ? b.urls
                : d.reduce(
                    f.children(a, "blockquote"),
                    function (a, b) {
            ...
            (j.build = function (a, b, c) {
              var d = b[0].iframe,
                ...
                g = function (a, b, c) {
                  return function (d) {
                    (a.__tunnel = new i.Tunnel(a.__hub)),
                      d.create(e.body, {
                        options: b,
                        extract: c,
                        tunnel: a.__tunnel,
                ...
                h = g(c, a, f);
              d.contentWindow.slideshows
                ? h(d.contentWindow.slideshows)
                : (d.contentWindow.onSlideshowsReady = h);
            }),
            (j.one = function (a, b, c) {
              ...
              return (
                ...
                j.fetch(i, n),
                a.parentNode.insertBefore(k.elem, a),
                k.on("slideshow.ready", function () {
                  k.ready();
                }),
                k.on("slideshow.rendered", function (b) {
                  return (
                    k.ready(),
                    "error" === b.name
                      ? (k.remove(), k.__hub.notify("slideshow.error", a), !1)
                      : ((k.rendered = !0),
                        (k.elem.style.display = "block"),
                        (k.elem.style.margin = "10px auto"),
                        (k.elem.style.visibility = "visible"),
                        (k.elem.style.position = "relative"),
                        (k.elem.width = "700"),
                        b.height
                          ? (k.elem.height = b.height)
                          : (k.elem.height = "500"),
                        b.width
                          ? (k.elem.width = b.width)
                          : (k.elem.width = "700"),
                        (k.elem.style.width = null),
                        (k.elem.style.height = null),
                        (k.elem.style.maxWidth = "99%"),
                        (k.elem.style.minWidth = "300px"),
                        void f.remove(a))
                  );
                }),
        ...
        function (a, b, c) {
          ...
          (f.Sender = e.extend({
            ...
            event: function (a, b, c) {
              ...
              return d.contains(this.sent, e)
                ? !1
                : (this.sent.push(e), void this.send(a, b, c));
            },
            send: function () {},
          })),
            ...
            (f.Heap = f.Sender.extend({
              ...
              send: function (a, b, c) {
                window.heap.track("Embedly > " + a + " > " + b, { url: c });
              },
            })),
              ...
              a.on("play", function () {
                ...
                a.on("timeupdate", function (b) {
                  if (
                    b.seconds &&
                    b.duration &&
                    d.isNumber(b.seconds) &&
                    d.isNumber(b.duration)
                  ) {
                    ...
                    c &&
                      ...
                      f.send(
                        "Video",
                        d.fmt("{n}% Watched", { n: (25 * c).toString() }),
                        a.url
                      );
                  }
                }),
            ...
            (f.event = function (a, b, c) {
              return a && b && c && "click" === b
                ? (d.contains(
                    ["facebook", "twitter", "pinterest", "repeat"],
                    a
                  ) && ((b = a), (a = "social")),
                  "article-full" === a && (a = "article"),
                  d.contains(
                    [
                      "video",
                      "image",
            ...
            (f.connect = function (a) {
              a.on("media.player", f.player),
                d.each(f.integrations, function (a) {
                  if (f._integrations.hasOwnProperty(a)) {
                    var b = f._integrations[a];
                    f.senders.push(new b());
                  }
          ...
          (e.prototype.init = function () {
            ...
            (e.prototype.done = function () {
              ...
              if (this.count === this.len) {
                this.finished = !0;
                for (var a = [], b = 0; b < this.len; b++)
                  a.push(this.results[b]);
            ...
            window.libringEventAPI = window.libringEventAPI || {
              track: function (a, b, c) {
                try {
                  ...
                  d.open("POST", "https://eventapi.libring.com/v1/event", !0),
                    d.setRequestHeader("Content-type", "text/plain"),
                    d.send(
                      '{"accessCode":"7AMXYZIYIVEDFM3CRPHEH33WQQ","data":[{"eventType":"' +
                        a +
                        '","values":{"url":"' +
                        b +
                        '","category":"' +
      ...
      19: [
        function (a, b, c) {
          ...
          (g.release = function () {
            var a = g._queue;
            (g._queue = []),
              e.console.log("log.release", a),
              g.hub.notify("xcomm.log.event", { events: a });
          }),
            (g.queue = function (a) {
            ...
            (g.event = function (a) {
              var b = { t: d.getTimestamp() };
              window.self === window.top
                ? ((b.r = document.location.toString()),
                  (b.rr = document.referrer))
                : (b.r = document.referrer),
                d.assert(a.g),
                d.assert(a.c),
                d.assert(a.a),
                (b = d.extend({}, b, a)),
                "reddit" !== b.c ||
                  ("load" !== b.a && "click" !== b.a && "view" !== b.a) ||
                  !window.libringEventAPI ||
                  window.libringEventAPI.track(b.a, b.u, b.r);
            }),
            (g.comms = function () {
              return g.connected
                ? !0
                ...
                ? g.connecting
                  ? !1
                  : ((g.connecting = !0),
                    g.hub.one("xcomm.ready", function () {
                      (g.connected = !0), g.release();
                    }),
                    void f.connect(g.hub, { name: g.name }))
                : !1;
            }),
        ...
        { "../browser.js": 4, "../comms.js": 6, "../utils.js": 29 },
      ],
      20: [
        function (a, b, c) {
          var d = a("./dom.js"),
            e = a("./utils"),
            f = { _event: null, _observer: null };
          (f.nodeNames = ["iframe", "a", "blockquote"]),
            (f.html = function () {
                  ...
                  if ("childList" === b.type && b.addedNodes) {
                    ...
                    e.each(c, function (b) {
                      e.each(f.recurse(b), function (b) {
                        b.nodeName &&
                          e.contains(f.nodeNames, b.nodeName.toLowerCase()) &&
                          a.notify(
                            "mutation.insert." + b.nodeName.toLowerCase(),
                            b
                          );
                      });
                    });
            ...
            (f.events = function (a) {
              ...
              return null === b
                ...
                : ((f._event = function (b) {
                  ...
                  d.addEvent(b, "DOMNodeInserted", f._event),
                  !0);
            }),
            (f.stop = function () {
              var a = f.html();
              return null === a
                ? !1
                : (f._event &&
                    (d.detachEvent(a, "DOMNodeInserted", f._event),
                    (f._event = null)),
                  void (
                    f._observer &&
                    (f._observer.disconnect(), (f._observer = null))
                  ));
            }),
            (f.connect = function (a) {
              return f._event || f._observer
                ? !1
                : void (f.observer(a) || f.events(a));
            }),
            (b.exports = f);
        },
        { "./dom.js": 7, "./utils": 29 },
      ...
      21: [
        function (a, b, c) {
          ...
          (h.connect = function (a, b) {
            ...
            if (
              !b &&
              g.PAGE_PROGRESS_DOMAINS &&
              !d.contains(g.PAGE_PROGRESS_DOMAINS, c)
            )
              return !1;
            ...
            f.started
              ? i()
              : (f.connect(a, { name: "platform" }), a.one("xcomm.ready", i));
          }),
            (b.exports = h);
        },
        {
        ...
        function (a, b, c) {
          function d(a) {
            return function () {
              ...
              /^get/.test(a)
                ? (e.assert(c.length > 0, "Get methods require a callback."),
                  c.unshift(b))
                : (/^set/.test(a) &&
                    (e.assert(0 !== c.length, "Set methods require a value."),
                    (b.value = c[0])),
                  (c = [b])),
          ...
          (g.CONTEXT = "player.js"),
            (g.VERSION = "0.0.11"),
            (g.bound = function (a, b) {
              return function (c) {
                a.call(b || window, c.value);
              };
            }),
            (g.Player = function (a) {
              return this instanceof g.Player
                ? void this.init(a)
                : new g.Player(a);
            }),
            (g.EVENTS = {
            ...
            (g.READIED = []),
            (g.Player.prototype.init = function (a) {
              (this.frame = a),
                (this.url = a.url),
                (this.events = g.EVENTS.all()),
                (this.methods = g.METHODS.all());
            }),
            (g.Player.prototype.send = function (a, b, c) {
              return (
                ...
                (a.version = g.VERSION),
                b
                  ? ((a.listener = "l" + e.getUUID()),
                    this.frame.one(
                      { event: a.method, listener: a.listener },
                      g.bound(b, c),
                      c
                    ))
                  : this.frame.on(a.method, b, c),
                this.frame.send(a.method, a),
                !0
              );
            }),
            (g.Player.prototype.on = function (a, b, c) {
              var d = e.getUUID(),
                f = { event: a, listener: d };
              return (
                "ready" === a
                  ? this.frame.one(f, g.bound(b, c), c)
                  : this.frame.on(f, g.bound(b, c), c),
                this.frame.send("addEventListener", {
            ...
            (g.Player.prototype.supports = function (a, b) {
              e.assert(
                e.indexOf(["method", "event"], a) > -1,
                'evtOrMethod needs to be either "event" or "method" got ' + a
              ),
                (b = e.isArray(b) ? b : [b]);
              for (
                var c = "event" === a ? this.events : this.methods, d = 0;
                d < b.length;
                d++
              )
            ...
            e.each(g.METHODS.all(), function (a) {
              g.Player.prototype.hasOwnProperty(a) ||
                (g.Player.prototype[a] = d(a));
            }),
            (g._all = []),
            ...
            (g.add = function (a, b) {
              ...
              a.notify("media.player", c, b.elem),
                g._all.push({ player: c, elem: b.elem });
            }),
      ...
      23: [
        ...
        { "./browser.js": 4, "./dom.js": 7, "./utils.js": 29 },
      ],
      24: [
        function (a, b, c) {
          var d = a("../urlparse.js"),
            e = a("../utils.js"),
            f = { enabled: !1, defaults: {}, options: {}, _queue: {} };
          (f.queue = function (a, b, c) {
            b
              ? b.send(a)
              : f._queue.hasOwnProperty(c)
              ? f._queue[c].push(a)
              : (f._queue[c] = [a]);
          }),
            (f.add = function (a, b) {
              ...
              if (f.enabled) {
                ...
                f.options.hasOwnProperty(a.elem) &&
                  (g = e.extend(g, f.options[a.elem])),
                  (g = e.extend(g, f.defaults)),
                  a.send("media.recommend", g),
                  a.on("media.recommend.shown", function (c) {
                    b.notify("recommend.shown", a.elem, c);
                  }),
                  f._queue.hasOwnProperty(a.elem) &&
                    (e.each(f._queue[a.elem], function (b) {
                      a.send(b);
                    }),
              ...
              a.on("media.recommend.options", function (b, c, d) {
                ...
                a.on("media.recommend.resize", function (a, b) {
                  ...
                  var c = a.parentNode,
                    ...
                    g = [
                      "relative" === d.position,
                      d.paddingBottom === d.height || d.paddingTop === d.height,
                      "absolute" === f.position,
                    ];
                  if (e.every(g)) {
        ...
        function (a, b, c) {
          ...
          (j.connect = function (a) {
            ...
            (j.buttons = function (a) {
              var b,
                c = e.create("div", { class: "embdscl0" });
              return (
                d.each(
                  ["facebook", "twitter", "pinterest", "linkedin", "card"],
                  function (d) {
                    (b = e.create("a", { class: "embd-" + d })),
                      (b.innerHTML = "<i></i>"),
                      j.buttons[d].call(window, b, a) === !0 &&
                        c.appendChild(b);
                  }
                ),
                c
            ...
            (j.buttons.twitter = function (a, b) {
              var c = b.options.url,
                ...
                i = { url: j.url(c) };
              return (
                f && (i.text = d.truncate(f, 100)),
                h
                  ? (i.via = "@" === h.substr(0, 1) ? h.substr(1) : h)
                  : (i.via = "embedly"),
                (a.href =
                  "https://twitter.com/intent/tweet?" + g.createQuery(i)),
                e.addEvent(a, "click", function (c) {
                  ...
                  d.stop(),
                    window.open(
                      a.href,
                      "_blank",
                      "width=550,height=410,top=150,left=150"
                    ),
                    j.log(b.options.url, "twitter");
                }),
                !0
              );
            }),
            (j.buttons.facebook = function (a, b) {
              var c = { u: j.url(b.options.url) };
              return (
                (a.href =
                ...
                e.addEvent(a, "click", function (c) {
                  ...
                  d.stop(),
                    window.open(
                      a.href,
                      "_blank",
                      "width=700,height=425,top=150,left=150"
                    ),
                    j.log(b.options.url, "facebook");
                }),
                !0
              );
            }),
            (j.buttons.pinterest = function (a, b) {
              var c,
                d = "https://www.pinterest.com/pin/create/button/";
              if (b.options.image) c = b.options.image;
              else if (b.extract.media && "photo" === b.extract.media.type)
                c = b.extract.media.url;
              else {
                if (!(b.extract.images && b.extract.images.length > 0))
                  return !1;
                c = b.extract.images[0].url;
              }
              return (
                (a.href = g.appendQuery(d, {
            ...
            (j.buttons.card = function (a, b) {
              return (
                e.addEvent(a, "click", function (a) {
                  var c = e.event(a);
                  c.stop();
                  var f = { url: b.options.url };
                  d.each(
                    ["image", "embed", "title", "description", "lang"],
                    function (a) {
                    ...
                    b.__hub.notify("card.repeat", f),
                    j.log(b.options.url, "repeat");
                }),
                !0
              );
            }),
            (j.buttons.linkedin = function (a, b) {
              var c = { url: j.url(b.options.url), mini: "true" };
              return (
                (a.href =
                  "https://www.linkedin.com/shareArticle?" + g.createQuery(c)),
                e.addEvent(a, "click", function (c) {
                  var d = e.event(c);
                  d.stop(),
                    window.open(
            ...
            (j.buttons.embedly = function (a, b) {
              ...
              return (
                (a.href = g.appendQuery("http://embed.ly/cards", c)),
                (a.target = "_blank"),
                e.addEvent(a, "click", function () {
            ...
            (j.card = function (a) {
              ...
              return !d.isElement(b) ||
                ("DIV" !== b.nodeName && !e.hasClass(b, "embedly-card"))
                ? !1
                : void j.css(function () {
                    var c = j.buttons(a);
                    e.addEvent(b, "mouseenter", function () {
                      ...
                      b.appendChild(c),
                      a.__hub.notify("card.share.init");
                  });
            }),
            (b.exports = j);
        },
      ...
      26: [
        function (a, b, c) {
          ...
          (g.youtube = {
            ...
            url: function (a) {
              ...
              return 2 !== b.length
                ? a
                : "http://www.youtube.com/watch?v=" + b[1];
            },
          }),
            (g.vimeo = {
              schema: "vimeo",
            ...
            (g.soundcloud = {
              ...
              url: function (a) {
                var b = e.getQuery(a);
                if (b.url) {
                  var c = /api\.soundcloud\.com\/tracks\/([^\/?#]+)/.exec(
                    b.url
                  );
                  if (2 === c.length)
                    return "https://soundcloud.com/track/" + c[1];
                }
                return a;
              },
            }),
            (g.providers = [g.youtube, g.vimeo, g.soundcloud]),
            (g.provider = function (a) {
              return d.reduce(
                g.providers,
                function (b, c) {
            ...
            (g.replace = function (a, b) {
              ...
              "file://" === c.substr(0, 7) && (c = c.substr(5)),
                "//" === c.substr(0, 2) && (c = i + c);
              var j = d.extend({}, b, {
                  url: h.url(c),
                  src: c,
        ...
        { "./urlparse.js": 28, "./utils.js": 29, conf: "conf" },
      ],
      27: [
        function (a, b, c) {
          var d = a("./utils.js"),
      ...
      28: [
        function (a, b, c) {
          ...
          (e.createQuery = function (a) {
            var b = [],
              c = "";
            return a && d.isObject(a) && !d.isEmptyObject(a)
              ...
              return (
                d.each(c, function (a) {
                  ...
                  1 === c.length
                    ...
                    : (b[d] = decodeURIComponent(c.slice(1).join("=")));
                }),
                b
              );
            }),
            ...
            (e.appendQuery = function (a, b) {
              ...
              return (
                (g = d.extend(g, b)),
                d.isEmptyObject(g) ? a : [f, e.createQuery(g)].join("?")
              );
            }),
            (e.removeQuery = function (a, b) {
              ...
              var c = a.split("?"),
                ...
                g = e.getQuery(a);
              return (
                g.hasOwnProperty(b) && delete g[b],
                d.isEmptyObject(g) ? f : [f, e.createQuery(g)].join("?")
              );
            }),
            ...
            (e.parse = function (a) {
              ...
              return a
                ? /^https?:\/\/[^\/]+\.[^\/]/i.test(a)
                  ...
                  ? f
                  : /^\/\/[^\/]+\.[^\/]/i.test(a)
                  ? (f.valid(!0), (f.url = c + a), f)
                  : /^\/([^\/]+|$)/i.test(a)
                  ? (f.valid(!0),
                    (f.url = e.getOrigin(window.location.toString()) + a),
                    f)
                  : /^[^\/]+\.[^\/]/i.test(a)
                  ? (f.valid(!0), (f.url = "http://" + a), f)
                  : f
                : f;
            }),
        ...
        function (a, b, c) {
          ...
          (e.identity = function (a) {
            ...
            (e.reduce = function (a, b, c, d) {
              ...
              if ((null == a && (a = []), m && a.reduce === m))
                return (
                  d && (b = e.bind(b, d)), f ? a.reduce(b, c) : a.reduce(b)
                );
              if (
                (e.each(a, function (a, e, g) {
            ...
            (e.extend = function (a) {
              return (
                e.each(Array.prototype.slice.call(arguments, 1), function (b) {
          ...
          (e.bind = function (a, b) {
            ...
            (e.isEmptyObject = function (a) {
              if (e.isObject(a)) {
                for (var b in a) if (h.hasOwnProperty.call(a, b)) return !1;
                return !0;
              }
              return !1;
            }),
          ...
          (g.prototype.init = function () {
            ...
            (g.prototype.check = function () {
              ...
              d.each(
                ...
                0 === this._elements.length && this.stop(),
                (this.freeze = !1);
            }),
            (g.prototype.stop = function () {
              try {
                e.detachEvent(window, "DOMContentLoaded", this.handler),
                  e.detachEvent(window, "load", this.handler),
                  e.detachEvent(window, "resize", this.handler),
                  e.detachEvent(window, "scroll", this.handler);
              } catch (a) {}
            ...
            (g.prototype.listen = function () {
              return this._listening
                ? !1
                : ((this._listening = !0),
                  (this.handler = d.bind(function () {
                    !this.freeze && this._elements.length && this.check();
                  }, this)),
                  e.addEvent(window, "DOMContentLoaded", this.handler),
                  e.addEvent(window, "load", this.handler),
                  e.addEvent(window, "resize", this.handler),
                  void e.addEvent(window, "scroll", this.handler));
            }),
            (g.prototype.on = function (a, b, c) {
              "viewable" === a &&
                (this._elements.push({ elem: b, func: c }),
                this.listen(),
                this.check());
            }),
            (b.exports = g);
      ...
      31: [
        function (a, b, c) {
          if (window.embedly && window.embedly.look)
            return window.embedly.look(), !1;
          var d = a("./common/iframes/all.js"),
            ...
            h = a("./common/dom.js"),
            i = a("./common/ready.js"),
            j = a("./common/viewport.js"),
            k = a("./common/page.js"),
            l = a("./common/urlparse.js"),
            m = a("./common/found.js"),
            n = a("./common/share.js"),
            o = a("./common/log/front.js"),
            p = a("./common/recommend/front.js"),
            q = a("./common/players.js"),
            r = a("./common/integrate.js"),
            s = a("./common/blacklist.js"),
            t = a("./common/libring.js"),
            u = new g(),
            v = new j();
          p.connect(u),
            n.connect(u),
          ...
          var w = function () {
            ...
            z = function (a) {
              ...
              u.notify("window.message", a, b);
            };
          h.addEvent(window, "message", z);
          var A = function (a, b, c) {
              var e;
              if (
                (f.isFunction(b) && ((c = b), (b = {})),
                f.isString(a) || (!f.isElement(a) && f.isObject(a)))
              )
                return m.add.cards(a), !0;
              if (
                f.isElement(a) &&
                ("a" === a.nodeName.toLowerCase() ||
                  "blockquote" === a.nodeName.toLowerCase())
              ) {
                var g = f.extend({}, x.defaults.cards, b);
                e = d.cards.one(a, g, u, function (a) {
            ...
            B = function (a) {
              ...
              return f.isString(a)
                ...
                : (f.isElement(a) &&
                    ...
                    (b = d.button.one(a, u)),
                  b &&
                    b.on("button.rendered", function () {
                      u.notify("button.rendered", b.elem, b);
                    }),
                  b);
            },
            C = function (a, b) {
              var c;
              c = f.isString(a) ? { url: a } : a;
              var e = d.modal.one(c, u);
              return f.isFunction(b) && b.call(e, e), e;
            },
            D = function (a, b, c) {
              var e = d.slideshow.one(a, b, u);
              return f.isFunction(c) && c.call(e, e), e;
            },
            E = function (a) {
              if ("1" === h.data(a, "connected")) return !1;
              h.data(a, "connected", "1");
              var b = d.connect(null, a, u);
              b.one("media.ready", function (a) {
                (b.url = a.url),
                  b.ready(),
                  v.on("viewable", b.elem, function () {
                    b.send("media.view");
                  }),
                  u.notify("media.recommend.add", b),
                  y.media.push(b),
                  a.controllable && u.notify("media.player.init", b),
                  u.notify("media.ready", b);
              }),
                b.on("media.recommend.resize", function (b) {
                  u.notify("media.recommend.resize", a, b);
                }),
                b.on("iframe.resize", function (a) {
                  a.height && (b.elem.height = a.height),
                    u.notify("media.resize", b);
                }),
                b.send("media.ready", {}, !0);
            },
            F = function (a) {
              return a && a.key ? ((m.analytics = a), void m.look()) : !1;
            },
            G = function (a, b) {
              if (!f.isElement(a)) return !1;
              if (f.isString(b)) {
                var c = !1;
                f.each(y.media, function (d) {
                  d.elem === a &&
                    ((c = !0), u.notify("media.recommend." + b, d, d.elem));
                }),
                  c || u.notify("media.recommend." + b, null, a);
              } else
                f.isObject(b) &&
                  u.notify("media.recommend.options", a, b, y.media);
              m.look();
            },
            H = function (a) {
              return f.isString(a) && "reset" === a
                ? ((x.defaults.cards = {}), !1)
                : f.isObject(a)
                ? (a.hasOwnProperty("cards") &&
                    f.isObject(a.cards) &&
                    (x.defaults.cards = f.extend(
                      {},
                      x.defaults.cards,
                      a.cards
                    )),
                  a.hasOwnProperty("recommend") &&
                    (u.notify(
                      "media.recommend.options",
                      null,
                      a.recommend,
                      y.media
                    ),
                    f.each(y.media, function (a) {
                      u.notify("media.recommend.add", a);
                    })),
                  void (
                    a.hasOwnProperty("integrations") &&
                    r.configure(a.integrations)
                  ))
                : !1;
            },
            I = function (a, b) {
              f.isFunction(a) && ((b = a), (a = null)), q.get(u, a, b);
            };
          u.on("found", function (a) {
            a.cards &&
              a.cards.length &&
              d.cards.multi(a.cards, x.defaults.cards, u),
              a.buttons &&
                a.buttons.length &&
                f.each(a.buttons, function (a) {
                  B(a);
                }),
              a.slideshows &&
                a.slideshows.length &&
                f.each(a.slideshows, function (a) {
                  D(a);
                }),
              a.iframes &&
                a.iframes.length &&
                f.each(a.iframes, function (a) {
                  E(a);
                });
          }),
            u.on("modal.create", function (a) {
              C(a);
            }),
            u.on("card.rendered", function (a, b) {
              v.on(
                "viewable",
                a,
                f.bind(function () {
              ...
              return c !== x.shared
                ...
                : ((x.shared = null),
                  void setTimeout(function () {
                    var a = h.rect(b.elem);
                    return a && a.top
                      ? void e.animateScroll(a.top - 5, 500)
                      : !1;
                  }, 500));
            });
          var J = !1;
          u.on("pinterest.log", function () {
            if (J) return !1;
            J = !0;
            var a = {
              type: "pidget",
            ...
            i.script(
              "https://log.pinterest.com/?" + l.createQuery(a),
              function () {
          ...
          var K = function (a, b) {
            ...
            M = function () {
              h.detachEvent(window, "message", z),
                m.stop(),
                u.clear(),
                h.remove(h.one("#emb_xcomm")),
                (window.embedly = null);
            },
            N = function () {
              var a = Array.prototype.slice.call(arguments, 0);
              ...
              switch (b) {
                ...
                case "look":
                  return m.look.apply(window, a);
                case "on":
                  return K.apply(window, a);
                case "off":
            ...
            O = function () {
              var a = [];
              window.embedly &&
                f.isFunction(window.embedly) &&
                f.isArray(window.embedly.q) &&
                (a = window.embedly.q),
                ...
                m.connect(u),
                i.bind(m.look),
                f.isFunction(window.onEmbedlyReady) &&
                  window.onEmbedlyReady.apply(this, [window.embedly]);
            };
          s.allowed(window.location.toString())
            ? O()
            : ((window.embedly = function () {}),
              f.each(
                ["card", "button", "modal", "slideshow", "look", "defaults"],
                function (a) {
        ...
        },
        {
          ...
          "./common/page.js": 21,
          "./common/players.js": 22,
          "./common/ready.js": 23,
          "./common/recommend/front.js": 24,
          "./common/share.js": 25,
          "./common/urlparse.js": 28,
          "./common/utils.js": 29,
          "./common/viewport.js": 30,
        },
      ],
      conf: [
        function (a, b, c) {
          !(function (a) {
            (a.EMB_DEBUG = !1),
              (a.EMB_HTTPS = "http:" !== window.location.protocol ? !0 : !1),
              (a.EMB_ORIGIN =
                (a.EMB_HTTPS ? "https" : "http") + "://cdn.embedly.com"),
              (a.EMB_ORIGIN_BASE = a.EMB_ORIGIN + "/"),
              (a.EMB_ASSET_VERSION = "eaa5ba97"),
              (a.EMB_FRAME_SRC = a.EMB_ORIGIN + "/widgets/"),
              (a.EMB_SECURE_FRAME_SRC = "https://cdn.embedly.com/widgets/"),
              (a.EMB_POST_MESSAGE = !!window.postMessage),
              (a.EMB_PROGRESS = !0),
              (a.EMB_APP_API = "https://app.embed.ly"),
              (a.EMB_API_KEY = "fd92ebbc52fc43fb98f69e50e7893c13");
            var b = window.location.pathname.split(".")[0].split("/");
            (a.EMB_GROUP = b[b.length - 1].toLowerCase()),
              (a.PAGE_PROGRESS_DOMAINS = []);
